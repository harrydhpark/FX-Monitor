...
const OFFLINE_COMMENTARIES = {
    ...
    "HUF": {
        "macro_commentary": "헝가리 포린트화는 헝가리 중앙은행(MNB)의 금리 인하 사이클과 EU 지원금 관련 마찰에도 불구하고, 글로벌 위험자산 선호 심리 회복에 힘입어 **310포린트 초중반에서 등락**하고 있습니다. 9월 4일 기준 누적 평균은 **315.23**으로 9월차 이동환율(312.22) 대비 소폭 약세(△1.0%) 구간에 있으나, 9월 4일 고시환율은 311.53으로 하향 안정세를 나타냈습니다. 헝가리의 경상수지 개선과 에너지 수입 비용 감소가 추가 약세를 방어하는 완충 장치 역할을 수행하고 있습니다. 향후 EU 재정 지원 자금 유입 재개 여부가 핵심 변수이며, 9월 말 예상 환율은 312.00, 3분기 평균은 약 313.51 수준으로 수렴할 것으로 전망됩니다.",
        "forecast": {
            "month_end": 312.0,
            "june_late": 312.0,
            "q3_avg": 313.51,
    ...
    "KRW": {
        "macro_commentary": "원화는 8월 중순 이후 **미국 연방준비제도(Fed)의 9월 기준금리 인하(Big Cut 가능성) 기대감**이 급부상하고 글로벌 달러 인덱스가 급락하면서, 기존 1,500원대의 극심한 고환율 국면에서 **1,360원대로 급격한 원화 강세(환율 하락)**로 전환되었습니다. 한국의 반도체 및 IT 수출 호조세가 지속되는 가운데 외국인 자금의 국내 증시 순매수가 재유입되며 원화 가치를 강력하게 견인하고 있습니다. 9월 4일 기준 일별 고시환율은 1,360원까지 하락하였으며, 9월 누적 평균 환율 또한 **1,368원**으로 전월 실적(1,408원) 대비 40원(약 2.8%) 낮아진 강세 흐름을 보이고 있습니다. 이는 당초 9월차 이동환율(1,400원) 대비로도 **약 2.3% 원화 강세** 구간에 해당합니다. 외환 당국의 구두 개입 및 미세 조정 속에 단기적으로 원/달러 환율은 **1,350원에서 1,380원 사이**에서 하방 압력을 지속 테스트할 것으로 전망되며, 9월 말 예상치는 1,361원, 3분기 평균은 1,423원 수준으로 전망됩니다.",
        "forecast": {
            "month_end": 1361,
            "june_late": 1361,
            "q3_avg": 1423,
